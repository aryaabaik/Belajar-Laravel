                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('dosen.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('dosen.show', $data->id) }}" class="btn btn-sm btn-outline-dark">Show</a> |
                                            <a href="{{ route('dosen.edit', $data->id) }}" class="btn btn-sm btn-outline-success">Edit</a> |
