                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ route('transaksi.show', $trx->id) }}" class="btn btn-sm btn-outline-dark">Show</a> |
                                            <a href="{{ route('transaksi.edit', $trx->id) }}" class="btn btn-sm btn-outline-success">Edit</a> |
