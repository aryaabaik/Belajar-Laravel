...
<style>
    ...
    * {
    ...
    /* kalau mau efek lembut di semua teks */
    .float-start, h2, h3, h4, h5, h6, th {
    font-weight: 700;
    ...
    /* Tambahin sedikit bayangan lembut biar font-nya hidup */
    .card-header, th {
                ...
                <div class="card-body">
                    <form action="{{ route('hobi.update', $hobi->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_hobi') is-invalid @enderror" name="nama_hobi" value="{{ $hobi->nama_hobi }}" placeholder="Name" required>
                            @error('nama_hobi')
